...
ユースケース_フロントエンド --> StateNotifier: 状態更新
ユースケース_フロントエンド --> Supabaseクライアント: リアルタイムデータ同期
ユースケース_フロントエンド --> APIクライアント: APIデータ更新等
...
APサーバ --> tRPC: エンドポイントメソッド実行

tRPC --> クエリサービス: クエリサービス実行
tRPC --> ユースケース_バックエンド: ユースケース実行
