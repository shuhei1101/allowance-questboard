...
CREATE TABLE IF NOT EXISTS level_table (
    ...
    subclass_type int NOT NULL REFERENCES member_level_sub_types (id) ON DELETE RESTRICT,
...
COMMENT ON COLUMN level_table.subclass_type IS 'サブクラスタイプ（member, family, shared）';
COMMENT ON COLUMN level_table.subclass_id IS 'サブクラスID（ポリモーフィック）';
COMMENT ON COLUMN level_table.created_at IS 'レコードの作成日時';
COMMENT ON COLUMN level_table.updated_at IS 'レコードの更新日時';
...
COMMENT ON COLUMN history.level_table.created_at IS '元レコードの作成日時';
COMMENT ON COLUMN history.level_table.updated_at IS '元レコードの更新日時';
COMMENT ON COLUMN history.level_table.recorded_at IS '履歴記録日時';

-- メンバーレベルテーブル
CREATE TABLE IF NOT EXISTS member_level_table (
    id serial PRIMARY KEY,
...
COMMENT ON TABLE member_level_table IS 'メンバー個人のレベル設定テーブル';
COMMENT ON COLUMN member_level_table.id IS 'メンバーレベルID（主キー）';
COMMENT ON COLUMN member_level_table.superclass_id IS 'レベルテーブルID（外部キー、一意制約）';
COMMENT ON COLUMN member_level_table.member_id IS 'メンバーID（外部キー）';
COMMENT ON COLUMN member_level_table.created_at IS 'レコードの作成日時';
COMMENT ON COLUMN member_level_table.updated_at IS 'レコードの更新日時';
...
COMMENT ON COLUMN family_level_table.created_at IS 'レコードの作成日時';
COMMENT ON COLUMN family_level_table.updated_at IS 'レコードの更新日時';
...
COMMENT ON COLUMN shared_level_table.created_at IS 'レコードの作成日時';
COMMENT ON COLUMN shared_level_table.updated_at IS 'レコードの更新日時';

-- メンバーレベル履歴テーブル
CREATE TABLE IF NOT EXISTS history.member_level_table (
    id serial PRIMARY KEY,
...
COMMENT ON TABLE history.member_level_table IS 'メンバーレベル設定の変更履歴を管理するテーブル';
COMMENT ON COLUMN history.member_level_table.id IS '履歴ID（主キー）';
COMMENT ON COLUMN history.member_level_table.member_level_table_id IS '元のメンバーレベルID（外部キー）';
COMMENT ON COLUMN history.member_level_table.superclass_id IS 'レベルテーブルID（外部キー）';
COMMENT ON COLUMN history.member_level_table.member_id IS 'メンバーID（外部キー）';
COMMENT ON COLUMN history.member_level_table.history_superclass_id IS '履歴レベルテーブルID（外部キー）';
COMMENT ON COLUMN history.member_level_table.created_at IS '元レコードの作成日時';
COMMENT ON COLUMN history.member_level_table.updated_at IS '元レコードの更新日時';
COMMENT ON COLUMN history.member_level_table.recorded_at IS '履歴記録日時';
...
COMMENT ON COLUMN history.family_level_table.created_at IS '元レコードの作成日時';
COMMENT ON COLUMN history.family_level_table.updated_at IS '元レコードの更新日時';
...
COMMENT ON COLUMN history.shared_level_table.created_at IS '元レコードの作成日時';
COMMENT ON COLUMN history.shared_level_table.updated_at IS '元レコードの更新日時';
...
COMMENT ON COLUMN allowance_by_level.created_at IS 'レコードの作成日時';
COMMENT ON COLUMN allowance_by_level.updated_at IS 'レコードの更新日時';
...
COMMENT ON COLUMN history.allowance_by_level.created_at IS '元レコードの作成日時';
COMMENT ON COLUMN history.allowance_by_level.updated_at IS '元レコードの更新日時';
