...
COMMENT ON COLUMN reports_translations.created_at IS '作成日時';
COMMENT ON COLUMN reports_translations.updated_at IS '更新日時';
...
COMMENT ON COLUMN history.reports_translations.created_at IS '元作成日時';
COMMENT ON COLUMN history.reports_translations.updated_at IS '元更新日時';
