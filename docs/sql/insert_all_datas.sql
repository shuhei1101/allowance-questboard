...
-- INSERT ALL DATAS
-- 
-- このファイルはすべてのINSERT文を統合し、整合性を保ったファイルです
-- ID関係を修正し、依存関係に基づいて適切な順序で配置しています
-- 
-- 実行日: 2025年6月20日
-- =============================================================================
...
-- 注意: 実際の環境では、Supabaseの認証システムで自動生成されるため、
-- 開発・テスト環境のみで使用してください
...
-- 実行完了履歴テーブル
-- -----------------------------------------------------------------------------
    INSERT INTO quest_completed_history (family_id, member_id, quest_id, completed_at, exp_gained, status) VALUES
-- 佐藤太郎の完了履歴
(1, 1, 1, '2025-06-15 18:00:00+09', 50, 'completed'),
(1, 1, 3, '2025-06-16 19:00:00+09', 100, 'completed'),
(1, 1, 5, '2025-06-17 16:00:00+09', 60, 'completed'),
-- 佐藤花子の完了履歴
(1, 2, 2, '2025-06-19 14:30:00+09', 30, 'completed'),
(1, 2, 1, '2025-06-20 17:00:00+09', 50, 'completed'),
-- 田中次郎の完了履歴
(2, 3, 3, '2025-06-17 17:30:00+09', 100, 'completed'),
(2, 3, 1, '2025-06-18 18:00:00+09', 50, 'completed'),
-- Emily Smithの完了履歴
(3, 4, 4, '2025-06-19 18:30:00+09', 80, 'completed'),
(3, 4, 6, '2025-06-20 20:00:00+09', 200, 'completed'),
-- 鈴木三郎の完了履歴
(4, 5, 5, '2025-06-18 15:00:00+09', 60, 'completed');

-- =============================================================================
-- 最終確認とコメント
-- =============================================================================
-- 
-- このファイルには以下の統合データが含まれています：
-- 1. 基本マスタデータ（言語、通貨、国、アイコン等）
-- 2. 認証・ユーザーデータ
-- 3. 家族・メンバーデータ
-- 4. お小遣いテーブル・設定データ
-- 5. クエスト関連データ（カテゴリ、テンプレート、詳細等）
-- 6. コメント関連データ
-- 7. 通知関連データ
-- 8. レポート関連データ
-- 9. 銀行・お小遣い記録データ
...
-- 11. 実行完了履歴データ
-- 
-- IDと外部キーの整合性を保ち、依存関係に基づいて適切な順序で配置しています。
-- 全てのデータは一意性制約とリレーションシップを考慮して調整されています。
-- 
-- 実行日: 2025年6月20日
-- =============================================================================
