...
export class QuestMemberStatusEntity extends AppBaseEntity {
  ...
  protected static seedData(): QuestMemberStatusEntity[] {
    return [
      Object.assign(new QuestMemberStatusEntity(), {
        code: "not_accepted",
        description: "未受注"
      }),
      Object.assign(new QuestMemberStatusEntity(), {
...
/**
 * クエストメンバーステータス翻訳エンティティ
 */
@Entity("quest_member_statuses_translation")
@Unique("uq_quest_member_statuses_translation", ["child_quest_status_id", "language_id"])
export class QuestMemberStatusTranslationEntity extends BaseTranslationEntity {
  ...
  @JoinColumn({ name: "child_quest_status_id", referencedColumnName: "id", foreignKeyConstraintName: "fk_quest_member_statuses_translation_child_quest_status_id" })
  child_quest_status_id_ref!: QuestMemberStatusEntity;
