...
import { QuestTypeEntity } from "./questType";
...
export class QuestEntity extends AppBaseEntity {
  ...
  // カテゴリとアイコンのリレーションは後で追加予定
  // @ManyToOne(() => QuestCategory, { nullable: false, onDelete: "RESTRICT" })
  // @JoinColumn({ name: "category_id", referencedColumnName: "id", foreignKeyConstraintName: "fk_quests_category_id" })
  // category!: QuestCategory;

  // @ManyToOne(() => Icon, { nullable: false, onDelete: "RESTRICT" })
