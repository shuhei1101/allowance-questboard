...
export type VerifyInviteCode = (params: VerifyInviteCodeParams) => Promise<VerifyInviteCodeResult>;
...
export const verifyInviteCode: VerifyInviteCode = async (params: VerifyInviteCodeParams): Promise<VerifyInviteCodeResult> => {
  // 招待コードで招待を検索
...
export type VerifyAndUseInviteCode = (params: VerifyAndUseInviteCodeParams) => Promise<VerifyAndUseInviteCodeResult>;
 ...
 * 主に家族参加処理で使用する。 */
export const verifyAndUseInviteCode: VerifyAndUseInviteCode = async (params: VerifyAndUseInviteCodeParams): Promise<VerifyAndUseInviteCodeResult> => {
  // まず招待コードを検証
