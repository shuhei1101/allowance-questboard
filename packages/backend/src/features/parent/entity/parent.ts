...
export class Parent extends AppBaseEntity {
  ...
  @JoinColumn({ name: "family_id", referencedColumnName: "id", foreignKeyConstraintName: "fk_parents_family_id" })
  family!: Family;

  @ManyToOne(() => FamilyMember, { nullable: false, onDelete: "CASCADE" })
  @JoinColumn({ name: "family_member_id", referencedColumnName: "id", foreignKeyConstraintName: "fk_parents_family_member_id" })
  family_member!: FamilyMember;

  /**
   * シード用データ取得
   */
  protected static seedData(): Parent[] {
